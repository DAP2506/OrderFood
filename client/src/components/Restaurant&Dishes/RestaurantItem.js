...
const RestaurantItem = ({ restaurant }) => {
  ...
  return (
    <div id="my-restaurant" className="card grey darken-3">
      <div className="card-content white-text">
        <div className="flow-text center">/* <span style={{ "color": "orange" }}>{name}</span> */</div>
        <blockquote>

          <p style={{ fontSize: "1.1rem", marginBottom: "0.5rem" }}>
            <span style={{ "color": "orange" }}>Address:</span> {address}<br></br><span style={{ "color": "orange" }} >Contact: </span> {contactNumber}
          </p>
          <p style={{ fontSize: "1.1rem", marginBottom: "0.5rem" }}>
            {cuisine}
          </p>
        ...
        <div className="">
          <div className="activator btn-floating left">
      ...
      <div className="card-action">
        <div className="card-links" style={{ justifyContent: "space-between" }}>
          ...
          >
            Edit
            <i className="large material-icons left">mode_edit</i>
          </a>
        </div>
      </div>
